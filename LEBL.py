...
# definim les classes per fer l'estructura de les portes i l'aeroport de Barcelona
class Gate:
    def __init__(self, name):
        self.name = str(name)
        self.occupied = False  # de moment la porta està lliure
        self.aircraft_id = ""  # no hi ha cap avió a la porta encara


class BoardingArea:
    def __init__(self, name, area_type):
        self.name = str(name)
        self.type = str(area_type)  # aquí guardem si es schengen o no
                        ...
                        while j < num_areas:
                            ...
                            if i < len(lines):
                                ...
                                if len(a_parts) >= 7:
                                    ...
                                    # creem el nom que tindran les portes (ex: T1BAaG1)
